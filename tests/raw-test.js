...
Elm.IntDict.make = function (_elm) {
   ...
   var union = F2(function (d1,
   d2) {
      return function () {
         var insertNoReplace = F2(function ($new,
         old) {
            return function () {
               switch (old.ctor)
               {case "Just": return old;
                  case "Nothing":
                  return $Maybe.Just($new);}
               _U.badCase($moduleName,
               "between lines 404 and 407");
            }();
         });
         return function () {
            ...
            {case "_Tuple2":
               switch (_v39._0.ctor)
                 {case "Empty": return _v39._1;}
                 switch (_v39._1.ctor)
                 {case "Empty": return _v39._0;}
                 switch (_v39._0.ctor)
                 {case "Leaf": return A3(insert,
                      _v39._0._0.key,
                      _v39._0._0.value,
                      _v39._1);}
                 switch (_v39._1.ctor)
                 {case "Leaf": return A3(update,
                      _v39._1._0.key,
                      insertNoReplace(_v39._1._0.value),
                      _v39._0);}
                 switch (_v39._0.ctor)
                 {case "Inner":
                    switch (_v39._1.ctor)
                      {case "Inner":
                         return function () {
                              var _v46 = A2(determineInnerRelation,
                              _v39._0._0,
                              _v39._1._0);
                              switch (_v46.ctor)
                              {case "LeftChild":
                                 ...
                                 case "Siblings":
                                 return A3(inner,
                                   _v46._0.parentPrefix,
                                   Inner(_v46._0.l),
                                   Inner(_v46._0.r));}
                              _U.badCase($moduleName,
                              "between lines 412 and 424");
                           }();}
                      break;}
                 break;}
            _U.badCase($moduleName,
            "between lines 407 and 424");
         }();
      }();
   });
   var filter = F2(function (predicate,
            ...
            switch (_v61._0.ctor)
              ...
              {case "Inner":
                 switch (_v61._1.ctor)
                   {case "Inner":
                      return function () {
                           var _v70 = A2(determineInnerRelation,
                           _v61._0._0,
                           _v61._1._0);
                           switch (_v70.ctor)
                           {case "LeftChild":
                              return _U.eq(_v70._0.p,
                                _v61._0._0) ? A2(intersect,
                                _v61._0._0.left,
                                d2) : A2(intersect,
                                d1,
                                _v61._1._0.left);
                           ...
                           _U.badCase($moduleName,
                           "between lines 434 and 449");
                        }();}
                   break;}
              break;}
         _U.badCase($moduleName,
         "between lines 427 and 449");
      }();
   });
   var diff = F2(function (d1,d2) {
      return function () {
         var _v74 = {ctor: "_Tuple2"
                    ,_0: d1
                    ,_1: d2};
         switch (_v74.ctor)
         {case "_Tuple2":
            switch (_v74._0.ctor)
              ...
              {case "Inner":
                 switch (_v74._1.ctor)
                   {case "Inner":
                      return function () {
                           var _v81 = A2(determineInnerRelation,
                           _v74._0._0,
                           _v74._1._0);
                           switch (_v81.ctor)
                           {case "LeftChild":
                              return _U.eq(_v81._0.p,
                                _v74._0._0) ? A3(inner,
                                _v74._0._0.prefix,
                                A2(diff,_v74._0._0.left,d2),
                                _v74._0._0.right) : A2(diff,
                                d1,
                                _v74._1._0.left);
                              case "RightChild":
                              return _U.eq(_v81._0.p,
                           ...
                           _U.badCase($moduleName,
                           "between lines 457 and 474");
                        }();}
                   break;}
              break;}
         _U.badCase($moduleName,
         "between lines 452 and 474");
      }();
   });
...
Elm.Main.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm),
   $Test$IntDict = Elm.Test.IntDict.make(_elm);
   var responses = Elm.Native.Port.make(_elm).inboundSignal("responses",
   "IO.Runner.Response",
   function (v) {
      return v;
   });
   ...
   "IntDict tests",
   _L.fromArray([$Test$IntDict.tests]));
   var console = $ElmTest$Runner$Console.runDisplay(tests);
   var requests = Elm.Native.Port.make(_elm).outboundSignal("requests",
   function (v) {
      return v;
   },
   A2($IO$Runner.run,
...
Elm.Test = Elm.Test || {};
Elm.Test.IntDict = Elm.Test.IntDict || {};
Elm.Test.IntDict.make = function (_elm) {
   "use strict";
   _elm.Test = _elm.Test || {};
   _elm.Test.IntDict = _elm.Test.IntDict || {};
   if (_elm.Test.IntDict.values)
   return _elm.Test.IntDict.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Test.IntDict",
   $Basics = Elm.Basics.make(_elm),
   $ElmTest$Assertion = Elm.ElmTest.Assertion.make(_elm),
   $ElmTest$Test = Elm.ElmTest.Test.make(_elm),
   $IntDict = Elm.IntDict.make(_elm),
   $Maybe = Elm.Maybe.make(_elm);
   var moreNumbers = $IntDict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                     ,_0: 2
                                                     ,_1: "2"}
                                                    ,{ctor: "_Tuple2"
                                                     ,_0: 5
                                                    ...
                                                    ,{ctor: "_Tuple2"
                                                     ,_0: 45
                                                     ,_1: "45"}]));
   var numbers = $IntDict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                 ,_0: 2
                                                 ,_1: "2"}
                                                ,{ctor: "_Tuple2"
                                                 ,_0: 3
                                                 ,_1: "3"}]));
   var tests = function () {
      var transformTests = A2($ElmTest$Test.suite,
      "transform Tests",
      _L.fromArray([$ElmTest$Test.test("filter")(A2($ElmTest$Assertion.assertEqual,
                   A2($IntDict.singleton,2,"2"),
                   A2($IntDict.filter,
                   F2(function (k,v) {
                      return _U.eq(k,2);
                   }),
                   numbers)))
                   ,$ElmTest$Test.test("partition")(A2($ElmTest$Assertion.assertEqual,
                   {ctor: "_Tuple2"
                   ,_0: A2($IntDict.singleton,
                   2,
                   "2")
                   ,_1: A2($IntDict.singleton,
                   3,
                   "3")},
                   A2($IntDict.partition,
                   F2(function (k,v) {
                      return _U.eq(k,2);
                   }),
                   numbers)))]));
      var combineTests = A2($ElmTest$Test.suite,
      "combine Tests",
      _L.fromArray([$ElmTest$Test.test("union")(A2($ElmTest$Assertion.assertEqual,
                   numbers,
                   A2($IntDict.union,
                   A2($IntDict.singleton,3,"3"),
                   A2($IntDict.singleton,2,"2"))))
                   ,$ElmTest$Test.test("union collison")(A2($ElmTest$Assertion.assertEqual,
                   A2($IntDict.singleton,2,"2"),
                   A2($IntDict.union,
                   A2($IntDict.singleton,2,"2"),
                   A2($IntDict.singleton,2,"3"))))
                   ,$ElmTest$Test.test("intersect")(A2($ElmTest$Assertion.assertEqual,
                   A2($IntDict.singleton,2,"2"),
                   A2($IntDict.intersect,
                   numbers,
                   A2($IntDict.singleton,2,"2"))))
                   ,$ElmTest$Test.test("diff")(A2($ElmTest$Assertion.assertEqual,
                   A2($IntDict.singleton,3,"3"),
                   A2($IntDict.diff,
                   numbers,
                   A2($IntDict.singleton,
                   2,
                   "2"))))]));
      var queryTests = A2($ElmTest$Test.suite,
      "query Tests",
      _L.fromArray([$ElmTest$Test.test("isEmpty - empty is empty")(A2($ElmTest$Assertion.assertEqual,
                   true,
                   $IntDict.isEmpty($IntDict.empty)))
                   ,$ElmTest$Test.test("isEmpty - non-empty dict is not empty")(A2($ElmTest$Assertion.assertEqual,
                   false,
                   $IntDict.isEmpty(numbers)))
                   ,$ElmTest$Test.test("size 1")(A2($ElmTest$Assertion.assertEqual,
                   0,
                   $IntDict.size($IntDict.empty)))
                   ,$ElmTest$Test.test("size 2")(A2($ElmTest$Assertion.assertEqual,
                   2,
                   $IntDict.size(numbers)))
                   ,$ElmTest$Test.test("size 3")(A2($ElmTest$Assertion.assertEqual,
                   5,
                   $IntDict.size(A2($IntDict.union,
                   numbers,
                   moreNumbers))))
                   ,$ElmTest$Test.test("member 1")(A2($ElmTest$Assertion.assertEqual,
                   true,
                   A2($IntDict.member,2,numbers)))
                   ,$ElmTest$Test.test("member 2")(A2($ElmTest$Assertion.assertEqual,
                   false,
                   A2($IntDict.member,
                   5234,
                   numbers)))
                   ,$ElmTest$Test.test("get 1")(A2($ElmTest$Assertion.assertEqual,
                   $Maybe.Just("2"),
                   A2($IntDict.get,2,numbers)))
                   ,$ElmTest$Test.test("get 2")(A2($ElmTest$Assertion.assertEqual,
                   $Maybe.Nothing,
                   A2($IntDict.get,5234,numbers)))
                   ,$ElmTest$Test.test("findMin")(A2($ElmTest$Assertion.assertEqual,
                   $Maybe.Just({ctor: "_Tuple2"
                               ,_0: 2
                               ,_1: "2"}),
                   $IntDict.findMin(numbers)))
                   ,$ElmTest$Test.test("findMax")(A2($ElmTest$Assertion.assertEqual,
                   $Maybe.Just({ctor: "_Tuple2"
                               ,_0: 3
                               ,_1: "3"}),
                   $IntDict.findMax(numbers)))]));
      var buildTests = A2($ElmTest$Test.suite,
      "build Tests",
      _L.fromArray([$ElmTest$Test.test("empty")(A2($ElmTest$Assertion.assertEqual,
                   $IntDict.fromList(_L.fromArray([])),
                   $IntDict.empty))
                   ,$ElmTest$Test.test("singleton")(A2($ElmTest$Assertion.assertEqual,
                   $IntDict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                   ,_0: 1
                                                   ,_1: "v"}])),
                   A2($IntDict.singleton,1,"v")))
                   ,$ElmTest$Test.test("insert")(A2($ElmTest$Assertion.assertEqual,
                   $IntDict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                   ,_0: 1
                                                   ,_1: "v"}])),
                   A3($IntDict.insert,
                   ...
                   "v",
                   $IntDict.empty)))
                   ,$ElmTest$Test.test("insert replace")(A2($ElmTest$Assertion.assertEqual,
                   $IntDict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                   ,_0: 1
                                                   ,_1: "vv"}])),
                   A3($IntDict.insert,
                   ...
                   "vv",
                   A2($IntDict.singleton,1,"v"))))
                   ,$ElmTest$Test.test("update")(A2($ElmTest$Assertion.assertEqual,
                   $IntDict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                   ,_0: 1
                                                   ,_1: "vv"}])),
                   A3($IntDict.update,
                   1,
                   function (v) {
                      return $Maybe.Just("vv");
                   },
                   A2($IntDict.singleton,1,"v"))))
                   ,$ElmTest$Test.test("update Nothing")(A2($ElmTest$Assertion.assertEqual,
                   $IntDict.empty,
                   A3($IntDict.update,
                   1,
                   function (v) {
                   ...
                   A2($IntDict.singleton,1,"v"))))
                   ,$ElmTest$Test.test("remove")(A2($ElmTest$Assertion.assertEqual,
                   $IntDict.empty,
                   A2($IntDict.remove,
                   1,
                   A2($IntDict.singleton,1,"v"))))
                   ,$ElmTest$Test.test("remove not found")(A2($ElmTest$Assertion.assertEqual,
                   A2($IntDict.singleton,1,"v"),
                   A2($IntDict.remove,
                   342,
                   A2($IntDict.singleton,
      ...
      "IntDict Tests",
      _L.fromArray([buildTests
                   ,queryTests
                   ,combineTests
                   ,transformTests]));
   }();
   _elm.Test.IntDict.values = {_op: _op
                              ,tests: tests};
   return _elm.Test.IntDict.values;
};
Elm.Text = Elm.Text || {};

               ...
               switch (_v43._0.ctor)
                 ...
                 {case "Inner":
                    switch (_v43._1.ctor)
                      {case "Inner":
                         return function () {
                              var _v50 = $Debug.log(A2($Basics._op["++"],
                              "Merging ",
                              A2($Basics._op["++"],
                              toString$(d1),
                              A2($Basics._op["++"],
                              " and ",
                              toString$(d2)))))(A2(determineInnerRelation,
                              _v43._0._0,
                              _v43._1._0));
                              switch (_v50.ctor)
                              {case "LeftChild":
                                 return _U.eq(_v50._0.p,
                                   _v43._0._0) ? A3(inner,
                                   _v50._0.p.prefix,
                                   A3(uniteWith,
                                   merger,
                                 ...
                                 return A3(inner,
                                   ...
                                   Inner(_v50._0.r));}
                              _U.badCase($moduleName,
                              "between lines 424 and 436");
                           }();}
                      break;}
                 break;}
            _U.badCase($moduleName,
            "between lines 419 and 436");
         }();
      }();
   });
                 ...
                 switch (_v65._1.ctor)
                   {case "Inner":
                      return function () {
                           ...
                           _U.badCase($moduleName,
                           "between lines 457 and 468");
                        }();}
                   break;}
              break;}
         _U.badCase($moduleName,
         "between lines 450 and 468");
      }();
   });
                 ...
                 switch (_v78._1.ctor)
                   {case "Inner":
                      return function () {
                           ...
                           _U.badCase($moduleName,
                           "between lines 480 and 491");
                        }();}
                   break;}
              break;}
         _U.badCase($moduleName,
         "between lines 475 and 491");
      }();
   });
...
Elm.Main.make = function (_elm) {
   ...
   var main = $ElmTest$Runner$Element.runDisplay($Test.tests);
...
Elm.Test.IntDict.make = function (_elm) {
   ...
   var numbers = $IntDict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                ...
                                                ,{ctor: "_Tuple2"
                                                 ...
                                                 ,_1: "3"}]));
   var tests = function () {
      var regressionTests = A2($ElmTest$Test.suite,
      "regressions Tests",
      _L.fromArray([$ElmTest$Test.suite("issue #1")(function () {
         var b = $IntDict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                 ,_0: 1
                                                 ,_1: 0}
                                                ...
                                                ,{ctor: "_Tuple2"
                                                 ,_0: 6
                                                 ,_1: 14}]));
         var a = $IntDict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                 ,_0: 4
                                                 ,_1: 20}
                                                ,{ctor: "_Tuple2"
                                                 ,_0: 6
                                                 ,_1: 11}]));
         return _L.fromArray([$ElmTest$Test.test("a union b")(A2($ElmTest$Assertion.assertEqual,
                             A2($IntDict.union,a,b),
                             $IntDict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                            ...
                                                            ,{ctor: "_Tuple2"
                                                             ,_0: 6
                                                             ,_1: 11}]))))
                             ,$ElmTest$Test.test("b union a")(A2($ElmTest$Assertion.assertEqual,
                             A2($IntDict.union,b,a),
                             $IntDict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                             ,_0: 1
                                                             ,_1: 0}
                                                            ,{ctor: "_Tuple2"
